...
const ProductCard = memo(function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    <div className="product-item bg-white rounded-lg border border-gray-200 hover:shadow-xl transition-shadow duration-300 overflow-hidden relative flex flex-col h-full pb-[200px]">
      ...
      <div className="absolute w-full bottom-0 left-0 px-3 pb-3">
        ...
        <button
          ...
          className="w-full bg-medical-green text-white py-2.5 px-4 rounded-md font-medium hover:bg-medical-green/90 transition-all duration-200 disabled:bg-gray-300 disabled:cursor-not-allowed flex items-center justify-center gap-2 relative overflow-hidden mb-2"
        >
